"""Exam models for Course Learning Platform."""
...
class Attempt(models.Model):
    ...
    def calculate_score(self):
        ...
        total_questions = self.exam.questions.filter(
    ...
    def finalize(self):
        ...
        self.is_passed = self.score >= self.exam.pass_score if self.score is not None else False
        self.save()
